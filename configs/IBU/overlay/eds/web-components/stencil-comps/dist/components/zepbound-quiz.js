...
import { a as archTypeProvider } from './p-BCZFNITE.js';
import { B as BackIcon } from './p-CRE7AF9B.js';
import { d as defineCustomElement$2 } from './p-DU1UVDQ7.js';
...
const ZepboundQuiz$1 = /*@__PURE__*/ proxyCustomElement(class ZepboundQuiz extends H {
    ...
    static get style() { return zepboundQuizCss; }
}, [257, "zepbound-quiz", {
        "quizDataOne": [8, "quiz-data-one"],
        "quizDataTwo": [8, "quiz-data-two"],
        "archetypeData": [8, "archetype-data"],
        "qnaset": [8],
        "test": [1],
        "quiztitle": [1],
        "url": [1],
        "quiz1ButtonLabel": [1, "quiz-1-button-label"],
        "quiz2ButtonLabel": [1, "quiz-2-button-label"],
        "isInitial": [32],
        "isClicked": [32],
        "capturedAnswer": [32],
        "capturedIndex": [32],
        ...
        "fetchStatus": [32],
        "isMobile": [32],
        "hasDownloadedImage": [32],
        "questions": [32],
        "archetypeScores": [32],
        "winningArchetypes": [32],
        "liveRegionText": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["zepbound-quiz", "zepbutton-component"];
    components.forEach(tagName => { switch (tagName) {
        case "zepbound-quiz":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZepboundQuiz$1);
            }
            break;
...
const ZepboundQuiz = ZepboundQuiz$1;
const defineCustomElement = defineCustomElement$1;

export { ZepboundQuiz, defineCustomElement };
//# sourceMappingURL=zepbound-quiz.js.map
