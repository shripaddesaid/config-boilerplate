...
import { d as CloseIcon } from './p-CRE7AF9B.js';
...
const ModalOverlay$1 = /*@__PURE__*/ proxyCustomElement(class ModalOverlay extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["modal-overlay"];
    components.forEach(tagName => { switch (tagName) {
        case "modal-overlay":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModalOverlay$1);
            }
            break;
    } });
}
...
const ModalOverlay = ModalOverlay$1;
const defineCustomElement = defineCustomElement$1;

export { ModalOverlay, defineCustomElement };
