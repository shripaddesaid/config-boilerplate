...
import { c as SensitiveEyeIcon, E as ExpandIcon, I as ImageErrorIcon } from './p-CRE7AF9B.js';
import { M as MOBILE_BREAKPOINT } from './p-xVQ0t8-X.js';
...
const ImageGallery$1 = /*@__PURE__*/ proxyCustomElement(class ImageGallery extends H {
    ...
    static get style() { return imageGalleryCss; }
        ...
        "images": [16],
        "initialImageCount": [2, "initial-image-count"],
        "displayedImageCount": [1026, "displayed-image-count"],
        "resultsTextTemplate": [1, "results-text-template"],
        "optionalClass": [1, "optional-class"],
        "galleryId": [1, "gallery-id"],
        "noImagesContent": [16],
        "sensitiveImageText": [1, "sensitive-image-text"],
        "seePhotoText": [1, "see-photo-text"],
        "imageLoadFailedText": [1, "image-load-failed-text"],
        "reloadButtonText": [1, "reload-button-text"],
        "isMobile": [32],
        "imageLoadStatus": [32],
        "imageRetryCount": [32],
        "focusedImageIndex": [32]
    }, undefined, {
        "images": ["watchImagesHandler"]
    }]);
