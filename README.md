...
## Environments
- Preview: https://main--config-boilerplate--shripaddesaid.aem.page/
- Live: https://main--config-boilerplate--shripaddesaid.aem.live/
...
1. Open the `config-boilerplate` directory in your favorite IDE and start coding :)
